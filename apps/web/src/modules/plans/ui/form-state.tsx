...
/**
 * Shared form-state glue for Plan Management forms (mirrors the gym/members modules): the
 * `useActionState` initial value, an inline result surface, and the per-field error accessor
 * for Zod's flattened `fieldErrors`. UI-only, no business logic.
 */
